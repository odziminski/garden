    ...
    @if (!Auth::guest())
        <div class="card-single-plant _alignCenter">
            ...
            @if ($plant->need_watering)
                <div class="needs">
                    <a href="{{ route('updateWatering',['id' => $plant->id]) }}" class="button">I have watered the
                        plant</a>
            ...
            @if ($plant->need_fertilizing)
                <div class="needs">
                    <a href="{{ route('updateFertilizing',['id' => $plant->id]) }}" class="button">I have fertilized the
                        plant</a>
            ...
            @endif
            <br/>
            <a href="{{ route('displayEditPlant',['id' => $plant->id]) }}"><button>Edit the plant</button></a><br/>

            <button onclick="openmodal('myModal')">Delete plant</button>
