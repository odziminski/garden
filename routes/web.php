...
Route::get('/updateW/{id}',[NeedsController::class, 'updateWatering'])->name('updateWatering');
Route::get('/updateF/{id}',[NeedsController::class, 'updateFertilizing'])->name('updateFertilizing');
